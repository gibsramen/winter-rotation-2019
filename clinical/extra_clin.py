...
CLIN_DIR = '/home/grahman/data/TCGA_clin/clin_dirs'
        ...
        for line in f:
            if re.search('vital_status', line):
                if re.search('dead', line, re.IGNORECASE):
                    status = 'Dead'
                if re.search('alive', line, re.IGNORECASE):
                    status = 'Alive'
